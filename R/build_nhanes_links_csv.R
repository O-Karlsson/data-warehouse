# R/build_nhanes_links_csv.R
#
# PURPOSE
# -------
# Fresh standalone NHANES builder that uses `data/NHANES links All.csv`
...
build_asset_manifest <- function(link_rows) {
  ...
  expanded <- bind_rows(lapply(asset_cols, function(col_nm) {
    ...
    filter(!.data$link_type %in% c("ftp_folder", "blank"))
